  ...
  computed: {
    ...
    getColumTableWidthDelOperWidth: function() {
      ...
      for (let index = 0; index < _this.getColumnLen; index++) {
        const width = _this.columns[index]['minWidth'] ? _this.columns[index]['minWidth'] : 100
    ...
    getColumn: function() {
      ...
      const newColum = []
      for (let index = 0; index < _this.getColumnLen; index++) {
        const item = _this.columns[index]
